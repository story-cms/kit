        ...
        >
          ...
          <template v-for="page in visiblePages" :key="page">
            <button
              ...
              :class="[
                page === currentPage
                  ? 'focus:outline-[--primary-color]/50 relative z-10 inline-flex items-center bg-[--primary-color] px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2'
