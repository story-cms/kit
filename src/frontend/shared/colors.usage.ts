...
export const colorUsage: Record<string, ColorUsage> = {
  ...
  'blue-400': { count: 3, files: [
      'audience/audience-index.vue',
      'index.css',
      'shared/pill-button.vue',
    ] },
  'blue-50': { count: 72, files: [
      'audience/audience-index.vue',
      'dashboard/dashboard-index.vue',
